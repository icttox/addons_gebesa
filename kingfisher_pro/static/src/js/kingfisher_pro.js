odoo.define('kingfisher_pro.kingfisher_pro_js', function(require) {
    ...
    // Multi image gallery for varient image change start  
    ProductConfiguratorMixin._onChangeCombinationProd = function (ev, $parent, combination) {
        var product_id = 0;
    ...
    sAnimations.registry.WebsiteSale.include({
        _onChangeCombination: function (){
            ...
            ProductConfiguratorMixin._onChangeCombinationProd.apply(this, arguments);
        }
    });
    // Multi image gallery for varient image change end
});