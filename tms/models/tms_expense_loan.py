...
class TmsExpenseLoan(models.Model):
    ...
    def action_approve(self):
        for rec in self:
            ...
            if (rec.discount_type == 'percent' and
    ...
    def action_confirm(self):
        for loan in self:
            ...
            total = loan.currency_id._convert(loan.amount, self.env.user.currency_id, loan.operating_unit_id.company_id, fields.Date.today())
            if total > 0.0:
