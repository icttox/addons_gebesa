...
class TmsRoute(models.Model):
    ...
    def get_route_info(self, error=False):
        for rec in self:
            ...
            # ur = https://maps.googleapis.com/maps/api/distancematrix/
            # xml?units=imperial&origins=[ORIGIN Location]&destinations=[DESTINATION Location]
            # &key=[YOUR_API_KEY]
            # https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial
            # &origins=Washington,DC&destinations=New+York+City,NY
            # &key=AIzaSyBEJa1xqGHtQkfhFlYUPG_HnDpsgTxStzM
