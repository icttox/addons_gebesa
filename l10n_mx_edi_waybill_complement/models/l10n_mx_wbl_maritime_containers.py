...
class L10nMxWblMaritimeContainers(models.Model):
    _name = 'l10n.mx.wbl.maritime.containers'
    _description = 'Maritime Cointainers configuration catalog'

    code = fields.Char(
        string='Code Maritime Containers',
        required=True,
    )
