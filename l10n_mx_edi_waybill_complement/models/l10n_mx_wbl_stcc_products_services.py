...
class L10nMxWblStccProductsServices(models.Model):
    _name = 'l10n.mx.wbl.stcc.products.services'
    _description = 'STCC Product Service configuration catalog'

    code = fields.Char(
        string='Code STCC Products Services',
        required=True,
    )
