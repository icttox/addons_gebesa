...
class L10nMxWblFigureTransport(models.Model):
    _name = 'l10n.mx.wbl.figure.transport'
    _description = 'Figure Transport Configuration Catalog'

    code = fields.Char(
        string="Code Figure Transport",
        required=True,
    )
