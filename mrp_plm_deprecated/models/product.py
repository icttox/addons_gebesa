...
class ProductTemplate(models.Model):
    ...
    eco_inprogress = fields.Boolean('ECO in progress?',
                                    compute='_compute_eco_data')
    eco_inprogress_count = fields.Integer('# ECOs in progress',
                                          compute='_compute_eco_data')
    ...
    def action_see_attachments(self):
        domain = [
            ...
            ('res_id', 'in', self.product_variant_ids.mapped('id')),
        ...
        return {
            ...
            'help': _('''<p class="oe_view_nocontent_create">
                        ...
                        like drawings or specifications.
                    </p>'''),
            'limit': 80,
