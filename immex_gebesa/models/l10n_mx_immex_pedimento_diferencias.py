...
class L10nMxImmexPedimentoDiferencias(models.Model):
    _name = 'l10n.mx.immex.pedimento.diferencias'
    ...
    def _compute_pedimento_id(self):
        for ped_dif in self:
            ped_dif.pedimento_id = self.env[
                'l10n.mx.immex.pedimento'].search([
                    ('clave_aduana', '=', ped_dif.clave_aduana),
                    ('num_pedimento', '=', ped_dif.num_pedimento),
                    ('patente', '=', ped_dif.patente)])
