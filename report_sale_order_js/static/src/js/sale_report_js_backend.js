odoo.define('report_sale_order_js.sale_report_js_generic', function (require) {
'use strict';
...
var sale_report_js_generic = Widget.extend(ControlPanelMixin, {
    ...
    render_searchview_buttons: function() {
        ...
        this.$searchview_buttons = $(QWeb.render("saleJsReports.searchView", {report_type: this.report_type, context: this.report_context}));
...
core.action_registry.add("sale_report_js_generic", sale_report_js_generic);
return sale_report_js_generic;
});
