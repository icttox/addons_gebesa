...
/* /openerp_crm/static/src/js/content/inject_dom.js defined in bundle 'web.assets_frontend_minimal' */
odoo.define('@openerp_crm/js/content/inject_dom',async function(require){'use strict';let __exports={};const{get_cookie}=require('web.utils.cookies');document.addEventListener('DOMContentLoaded',()=>{const htmlEl=document.documentElement;const cookieNamesToDataNames={'utm_source':'utmSource','utm_medium':'utmMedium','utm_campaign':'utmCampaign',};for(const[name,dsName]of Object.entries(cookieNamesToDataNames)){const cookie=get_cookie(name);if(cookie){htmlEl.dataset[dsName]=cookie.replace(/(^["']|["']$)/g,'');}}});return __exports;});