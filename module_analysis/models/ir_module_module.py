...
class IrModuleModule(models.Model):
    ...
    def button_analyse_code(self):
        ir_module_author = self.env['ir.module.author']
        ir_module_type_rule = self.env['ir.module.type.rule']
        rules = ir_module_type_rule.search([])
        ...
        for module in self:
            ...
            for author_txt in author_txt_list:
                authors.append(ir_module_author._get_or_create(author_txt))
