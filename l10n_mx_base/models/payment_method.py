...
class L10nMxPayMethod(models.Model):
    ...
    _name = 'l10n_mx.payment.method'
    _description = 'descripcion pendiente'

    name = fields.Char(
        required=True, help='Payment method, is found in the '
        'SAT catalog.')

    code = fields.Char(
        required=True, help='Code defined by the SAT by this payment method. '
        'This value will be set in the XML in the element "metodoDePago".')

    active = fields.Boolean(
        default=True, help='If you not want show this payment method, must '
        'inactive this register.')
